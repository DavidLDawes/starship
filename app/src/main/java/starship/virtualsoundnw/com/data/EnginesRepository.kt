...
interface EnginesRepository {
    ...
    suspend fun addEngine(engine: Engine)
    suspend fun removeEngine(engine: Engine)
    suspend fun clearEnginesForShip(shipId: Int)
    suspend fun clearEnginesForShipByType(shipId: Int, engineType: EngineType)
}